...
<!-- PBR 선택 -->		
		<tr>
			<th colspan="8" style="text-align: center;font-size:large;background-color:#f0f0f0;"> 3 > PBR > 2 </th>
		</tr>
		...
		<tr>
			<td><a href="pbrband.do?code=<%=check.get(i).getCode3()%>"><%=check.get(i).getCode3()%></a></td>
			<td><a href="pbrband.do?code=<%=check.get(i).getCode3()%>"><%=check.get(i).getName3()%></a></td>

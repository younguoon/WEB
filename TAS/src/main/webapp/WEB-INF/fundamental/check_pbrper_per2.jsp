...
<body>
	...
	<table class="table table-bordered" style="text-align:center;width: 70%" align="center">
		...
		<tr>
			<th colspan="8" style="text-align: center;font-size:large;background-color:#f0f0f0;"> 9 > PER > 6 </th>
		</tr>
		...
		<tr>
			...
			<td><%=check.get(i).getEps9()*12%></td>
			<td><%=check.get(i).getEps9()*16%></td>
		</tr>  
		<% }} %>

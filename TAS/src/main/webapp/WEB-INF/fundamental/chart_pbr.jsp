...
<!-- pingendo start -->
<%-- 		<h2>total : <%= Integer.toString(stockClose.get(0).getWeek()).substring(0,8)%>,
			-- 상장일 --
			year  : <%= Integer.toString(stockClose.get(0).getWeek()).substring(0,4)%>,
		 	month : <%= Integer.toString(stockClose.get(0).getWeek()).substring(4,6)%>,
		 	week  : <%= Integer.parseInt(Integer.toString(stockClose.get(0).getWeek()).substring(6,7))*7%>
		</h2> --%>
	  <!--전체 틀 -->

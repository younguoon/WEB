...
<!-- PBR 선택 -->		
		<tr>
			<th colspan="8" style="text-align: center;font-size:large;background-color:#f0f0f0;"> 2 > PBR > 1 </th>
		</tr>
		...
		<tr>
			<td><a href="pbrband.do?code=<%=check.get(i).getCode2()%>"><%=check.get(i).getCode2()%></a></td>
			<td><a href="pbrband.do?code=<%=check.get(i).getCode2()%>"><%=check.get(i).getName2()%></a></td>

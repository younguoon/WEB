															...
															<tr>
																<td>
																	<table cellpadding="0" cellspacing="0" border=0>
																		...
																		<tr>
																			<td colspan=3><img
																				src="/stockPro/resources/images/page_login.gif"></td>
																		</tr>
																		<tr>
																			<td height=25></td>
																		</tr>
																		<tr>
																			<td background="/stockPro/resources/images/inputBg.gif"><img
																				src="/stockPro/resources/images/login_id.gif"></td>
																			<td background="/stockPro/resources/images/inputBg.gif"><input
																			...
																			<td rowspan=3 style="padding-left: 10" valign=bottom>
																				<input type='image' src="/stockPro/resources/images/btn_login.gif"
																				border="0" tabindex=3 >
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td background="/stockPro/resources/images/inputBg.gif"><img
																				src="/stockPro/resources/images/login_pass.gif"></td>
																			<td background="/stockPro/resources/images/inputBg.gif"><input

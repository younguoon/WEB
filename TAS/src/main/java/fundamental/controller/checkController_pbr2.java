...
@Controller
public class checkController_pbr2 extends HttpServlet{
	@Autowired
	FundamentalService service;
	
	@RequestMapping(value = "/checkpbrper_pbr2.do", method = RequestMethod.GET)
...
//		mav.addObject("bps",bps);
		mav.setViewName("check_pbrper_pbr2");
		return mav;
	}
}

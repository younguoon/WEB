...
@Controller
public class checkController_per5 extends HttpServlet{
	@Autowired
	FundamentalService service;
	
	@RequestMapping(value = "/checkpbrper_per5.do", method = RequestMethod.GET)
...
//		mav.addObject("bps",bps);
		mav.setViewName("check_pbrper_per5");
		return mav;
	}
}

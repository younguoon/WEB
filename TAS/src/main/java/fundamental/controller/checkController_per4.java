...
@Controller
public class checkController_per4 extends HttpServlet{
	@Autowired
	FundamentalService service;
	
	@RequestMapping(value = "/checkpbrper_per4.do", method = RequestMethod.GET)
...
//		mav.addObject("bps",bps);
		mav.setViewName("check_pbrper_per4");
		return mav;
	}
}

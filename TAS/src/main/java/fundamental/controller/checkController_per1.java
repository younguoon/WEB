...
@Controller
public class checkController_per1 extends HttpServlet{
	@Autowired
	FundamentalService service;
	
	@RequestMapping(value = "/checkpbrper_per1.do", method = RequestMethod.GET)
...
//		mav.addObject("bps",bps);
		mav.setViewName("check_pbrper_per1");
		return mav;
	}
}

...
@Controller
public class checkController_per2 extends HttpServlet{
	@Autowired
	FundamentalService service;
	
	@RequestMapping(value = "/checkpbrper_per2.do", method = RequestMethod.GET)
...
//		mav.addObject("bps",bps);
		mav.setViewName("check_pbrper_per2");
		return mav;
	}
}
